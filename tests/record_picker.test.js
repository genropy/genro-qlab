...
const GNRHOME = process.env.GNRHOME || path.resolve(__dirname, '../../../genropy');
...
function runtime() {
    ...
    for (const file of [path.join(GNRHOME, 'gnrjs/gnr_d11/js/gnrlang.js'), path.join(GNRHOME, 'gnrjs/gnr_d11/js/gnrbag.js'),
        path.join(__dirname, '../packages/qlab/resources/recordpicker/recordpicker.js')]) {
